...
class KnowledgeAugmentedPromptAgent:
    ...
    def respond(self, input_text):
        ...
        system_prompt = (
            ...
            f"3. You MUST answer strictly using ONLY the knowledge provided below, not your own.\n"
            f"4. If the knowledge does not contain the answer, reply: 'The knowledge provided is insufficient.'\n\n"
            f"--- KNOWLEDGE START ---\n"
            f"{self.knowledge}\n"
            f"--- KNOWLEDGE END ---"
        )
