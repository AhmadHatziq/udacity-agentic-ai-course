...
knowledgeAugmentedAgent = KnowledgeAugmentedPromptAgent(
...
knowledge_augmented_agent_response = knowledgeAugmentedAgent.respond(input_text=prompt)
print("PROMPT: ", prompt)
print("AGENT OUTPUT: \n", knowledge_augmented_agent_response)